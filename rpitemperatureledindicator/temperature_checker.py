...
class TemperatureChecker:
	def __init__(self, conf, temperatureEventHandler, temperatureHelper, applicationExitHelper):
		self.__conf = conf
	...
	def start(self):
		...
		while (True): 
			...
			if (self.__applicationExitHelper.sleepWhileNotExitRequested(self.__conf.TemperatureReadSleepInterval)):
		...
		while (True):		
			...
			if (self.__applicationExitHelper.sleepWhileNotExitRequested(5)):
